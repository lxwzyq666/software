...
input_dir  = os.path.expanduser(r'E:\research\dataset\HDFS\raw')
output_dir = '../output/hdfs/'  # The output directory of parsing results
log_file   = "HDFS.log"  # The input log file name

log_structured_file = r"E:\python_project\logbert-main\logbert-main\output\hdfs\HDFS.log_structured.csv"
log_templates_file = r"E:\python_project\logbert-main\logbert-main\output\hdfs\HDFS.log_templates.csv"
